...
public class pengembalian extends javax.swing.JFrame {
    ...
    public pengembalian() {
        ...
        tampildata();
        tampil_cmb_kode_pinjam();
        init();
        jbc_tanggal_pengembalian.setDateFormatString("yyyy-MM-dd");
    }
    private void init(){
        txt_kode_pengembalian.setText("");
    }
    public void tampil_cmb_kode_pinjam()
    {
        try {            
            String sql = "SELECT kode_pinjam FROM detail_pinjam ";
            ...
            while (res.next()) {                
                ...
                cmb_kode_pinjam.addItem((String) obj[0]);   
            }
     ...
     public void tampildata(){
        ...
        try {            
            ...
            while (res.next()) {                
                ...
                obj[1] = res.getString("kode_pinjam"); 
    ...
    private void initComponents() {
        ...
        cmb_kode_pinjam = new javax.swing.JComboBox<>();
        nama5 = new javax.swing.JLabel();
        jbc_tanggal_pengembalian = new com.toedter.calendar.JDateChooser();
        ...
        jScrollPane3.setViewportView(tbl_pengembalian);
        ...
        nama1.setText("Kode Pengembalian");
        ...
        nama4.setText("Kode peminjaman");

        cmb_kode_pinjam.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih --" }));
        ...
        nama5.setText("Tanggal pengembalian");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txt_kode_pengembalian, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                    .addComponent(cmb_kode_pinjam, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jbc_tanggal_pengembalian, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txt_kode_pengembalian, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(nama4, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cmb_kode_pinjam, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(nama5, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jbc_tanggal_pengembalian, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        try {
            ...
            String aaa = String.valueOf(format.format(jbc_tanggal_pengembalian.getDate()));
            String sql ="UPDATE pengembalian SET kode_pinjam = '"+cmb_kode_pinjam.getSelectedItem()+"',"
                    + "tanggal_pengembalian='"+aaa+"'WHERE kode_pengembalian = '"+txt_kode_pengembalian.getText()+"'";
    ...
    private void tbl_pengembalianMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_pengembalianMouseClicked
        ...
        try {
            ...
            jbc_tanggal_pengembalian.setDate(date2);
        } catch (ParseException ex) {
            Logger.getLogger(detail_peminjaman.class.getName()).log(Level.SEVERE, null, ex);
        }
        String kode_pengembalian =tbl_pengembalian.getValueAt(baris, 0).toString();
        txt_kode_pengembalian.setText(kode_pengembalian);
        String kode_pinjam = tbl_pengembalian.getValueAt(baris,1).toString();
        cmb_kode_pinjam.setSelectedItem(kode_pinjam);
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        try {
            ...
            SimpleDateFormat format = new SimpleDateFormat(pattern);
            String aaa = String.valueOf(format.format(jbc_tanggal_pengembalian.getDate()));
            String sql = "INSERT INTO pengembalian (kode_pengembalian,kode_pinjam,tanggal_pengembalian) VALUES "
            + "('"+txt_kode_pengembalian.getText()+"',"
            + "'"+cmb_kode_pinjam.getSelectedItem()+"',"
            + "'"+aaa+"')";
     ...
     private void resetdata(){
        ...
        cmb_kode_pinjam.setSelectedItem(null);
//        jbc_tanggal_pinjam.setDate(null);  
    ...
    private javax.swing.JComboBox<String> cmb_kode_pinjam;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JPanel jPanel3;
    private javax.swing.JScrollPane jScrollPane3;
    private com.toedter.calendar.JDateChooser jbc_tanggal_pengembalian;
